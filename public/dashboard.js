...
themeButton.addEventListener('click', () => {
    ...
    localStorage.setItem('selected-icon', getCurrentIcon())
            ...
            // Recupera lo sfondo salvato
let sfondoSalvato = localStorage.getItem("sfondo");
    
if (sfondoSalvato) {
    document.body.style.backgroundImage = `url('${sfondoSalvato}')`;
    document.body.style.backgroundSize = "1280px x720px"; // Copre l'intera area
    document.body.style.backgroundPosition = "center"; // Centra l'immagine
    document.body.style.backgroundAttachment = "fixed"; // Fissa lo sfondo durante lo scroll
     }
function vaiASelezioneSfondi() {
        window.location.href = '/app.sfondi.html'; 
     }